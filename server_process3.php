<?php
	...
	*/
	...
	/* Nombre de La Tabla */
	$sTabla = "catalogo_alumnos";
	
	/* Array que contiene los nombres de las columnas de la tabla*/
	$aColumnas = array( 'id', 'nombre','ap','am','matricula','idmodalidad','grupo','curso_modelo' );
	...
	*/
	...
	while ( $aRow = $rResult->fetch_array())
	{
		...
		$row[] = "<td><a href='modificar3.php?id=".$aRow['id']."'><span class='glyphicon glyphicon-pencil'></span></a></td>";
		$row[] = "<td><a href='#' data-href='eliminar3.php?id=".$aRow['id']."' data-toggle='modal' data-target='#confirm-delete'><span class='glyphicon glyphicon-trash'></span></a></td>";
